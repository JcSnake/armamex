...
function sendEmailContact(frm) {
	//var loading = document.getElementById('frmSpinner');
	...
	$.ajax({
		...
		beforeSend: function() {
			...
			loading.className = 'uk-text-center';
		},
		success: function(response) {
			...
			alertUser(msg);
			frm.frmName.className += 'uk-button uk-width-1-1';
			//loading.className = 'uk-text-center uk-hidden';
		},
