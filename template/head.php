<head>
    <meta charset="UTF-8">
    <meta name="description" content="<?=$lng['metaDescription']?>">
    <meta name="keywords" content="<?=$lng['metaKeywords']?>">
    <meta name="dcterms.rightHolder" content="<?=$lng['dcterms']?>">
    ...
    <link rel="mask-icon" href="assets/images/favicon/safari-pinned-tab.svg" color="#3a79b0">
    <meta name="msapplication-TileColor" content="#162549">
