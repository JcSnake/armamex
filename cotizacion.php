                        ...
                        <div class="uk-grid">
                            <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3 uk-margin-bottom">
                                ...
                                <div class="uk-form-controls">
                                    <input id="cotizacionName" name="cotizacionName" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['contactNameF']?>">
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3 uk-margin-bottom">
                                <label class="uk-form-label uk-hidden-small" for="cotizacionEmail"><?=$lng['contactMail']?>:</label>
                                <div class="uk-form-controls">
                                    <input id="cotizacionEmail" name="cotizacionEmail" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['contactMailF']?>">
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3">
                                ...
                                <div class="uk-form-controls">
                                    <input id="cotizacionService" name="cotizacionService" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['contactService']?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="uk-form-row">
                        <div class="uk-grid">
                            <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3 uk-margin-bottom">
                                ...
                                <div class="uk-form-controls">
                                    <input id="cotizacionPhone" name="cotizacionPhone" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['contactPhoneF']?>">
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3 uk-margin-bottom">
                                <label class="uk-form-label uk-hidden-small" for="cotizacionFletador"><?=$lng['contactFletador']?>:</label>
                                <div class="uk-form-controls">
                                    <input id="cotizacionFletador" name="cotizacionFletador" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['contactFletador']?>">
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3">
                            ...
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-2">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Quantity" name="cotOpt1Quantity" class="uk-width-1-1 am-form-field " type="text" placeholder="<?=$lng['opt1Field01']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt1Type"><?=$lng['opt1Field02']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Type" name="cotOpt1Type" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt1Field02']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt1Capacity"><?=$lng['opt1Field03']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Capacity" name="cotOpt1Capacity" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt1Field03']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt1Area"><?=$lng['opt1Field04']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Area" name="cotOpt1Area" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt1Field04']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-2">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Entrega" name="cotOpt1Entrega" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt1Field05']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt1Principal"><?=$lng['opt1Field06']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Principal" name="cotOpt1Principal" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt1Field06']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt1Extension"><?=$lng['opt1Field07']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt1Extension" name="cotOpt1Extension" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt1Field07']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                ...
                                <div class="uk-form-row">
                                    <div class="uk-text-right">
                                        <button id="am-send-fletamentos" name="cot1" type="button" class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-1-3 uk-button uk-button-primary"><?=$lng['sendButton']?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-2">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Salida" name="cotOpt2Salida" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field01']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Peso"><?=$lng['opt2Field02']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Peso" name="cotOpt2Peso" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field02']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Esolra"><?=$lng['opt2Field03']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Eslora" name="cotOpt2Eslora" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field03']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Calado"><?=$lng['opt2Field04']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Calado" name="cotOpt2Calado" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field04']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOptTRB"><?=$lng['opt2Field05']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2TRB" name="cotOptTRB" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field05']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-2">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Entrada" name="cotOpt2Entrada" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field06']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Desplazamiento"><?=$lng['opt2Field07']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Desplazamiento" name="cotOpt2Desplazamiento" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field07']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt2Condicion" name="cotOpt2Condicion" class="uk-width-1-1 am-form-field" type="text" placeholder="<?=$lng['opt2Field09']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-2">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt3Salida" name="cotOpt3Salida" class="uk-width-1-1" type="text" placeholder="<?=$lng['opt3Field01']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Peso"><?=$lng['opt3Field02']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt3Peso" name="cotOpt3Peso" class="uk-width-1-1" type="text" placeholder="<?=$lng['opt3Field02']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Esolra"><?=$lng['opt3Field03']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt3Esolra" name="cotOpt3Esolra" class="uk-width-1-1" type="text" placeholder="<?=$lng['opt3Field03']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOpt2Calado"><?=$lng['opt3Field04']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt3Calado" name="cotOpt3Calado" class="uk-width-1-1" type="text" placeholder="<?=$lng['opt3Field04']?>">
                                    </div>
                                </div>
                                <div class="uk-form-row">
                                    <label class="uk-form-label uk-text-right uk-hidden-small am-form-label" for="cotOptTRB"><?=$lng['opt3Field05']?>:</label>
                                    <div class="uk-form-controls am-form-controls">
                                        <input id="cotOpt3TRB" name="cotOpt3TRB" class="uk-width-1-1" type="text" placeholder="<?=$lng['opt3Field05']?>">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-small-1-1 uk-width-medium-1-2 uk-width-large-1-2">
